      ...
      <div className='h-[580px] flex justify-between md:flex-row items-center'>
        ...
        <div className='md:w-1/2'>
          ...
          <p className='text-lg text-white capitalize my-8 md:w-2/3 leading-[32px]'>
            Deslumbra con elegancia. Descubre nuestra exclusiva colección de vestidos de noche, ahora disponible en nuestra tienda en linea.
          </p>
          <button className='px-6 py-2 bg-white text-black rounded-sm font-semibold'>Ver coleccion</button>
        </div>
      </div>
    </div>
  )

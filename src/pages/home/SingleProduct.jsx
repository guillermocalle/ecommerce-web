    ...
    <div className='mt-28 max-w-screen-2xl container mx-auto xl:px-28 px-4'>
      <div className='p-3 max-w-7xl m-auto'>
        ...
        <div className='mt-5'>
          ...
          <a href="/shop" className='font-bold text-black'> / Compra</a>
        </div>
            ...
            <div>
              ...
              <div className='mt-4'>
                ...
                <div className='w-full text-left my-4'>
                  <button className='flex justify-center items-center gap-2 w-full py-3 px-4 bg-red-500 text-white font-bold border border-red-500 rounded-md ease-in-out duration-150 shadow-slate-600 hover:bg-white hover:text-red-500 lg:m-0 md:px-6'><span>Confirmacion de pedido</span><FaArrowAltCircleRight/></button>
                </div>
              </div>
            </div> 
          </div>

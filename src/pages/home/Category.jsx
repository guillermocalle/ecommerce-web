  ...
  return (
    <div className='max-w-screen-2xl mx-auto container xl:px-28 px-4 py-28'>
      ...
      <div className='mt-8 flex flex-col md:flex-row items-center gap-4'> 
        <p className='font-semibold uppercase md:-rotate-90 text-center bg-black text-white md:p-1.5 rounded-sm inline-flex'>Explora las ultimas novedades de estilo</p>
        <div>
